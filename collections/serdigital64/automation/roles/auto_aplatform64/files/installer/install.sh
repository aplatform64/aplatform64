...
export APLATFORM64_MODULES='application automation backup cloud container devops development'
APLATFORM64_MODULES="$APLATFORM64_MODULES hardware hypervisor infrastructure security storage system web"
