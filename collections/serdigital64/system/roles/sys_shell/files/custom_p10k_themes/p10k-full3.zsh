# Generated by Powerlevel10k configuration wizard on 2022-02-13 at 19:26 -03.
...
() {
  ...
  #=X=#typeset -g POWERLEVEL9K_SHORTEN_STRATEGY=truncate_to_unique
  ...
  #=X=#typeset -g POWERLEVEL9K_SHORTEN_DIR_LENGTH=1
  ...
  #=X=#typeset -g POWERLEVEL9K_DIR_MAX_LENGTH=80
  typeset -g POWERLEVEL9K_DIR_MAX_LENGTH='100%'
  # When `dir` segment is on the last prompt line, try to shorten it enough to leave at least this
  # many columns for typing commands.
  #=X=typeset -g POWERLEVEL9K_DIR_MIN_COMMAND_COLUMNS=40
  ...
  #=X=#typeset -g POWERLEVEL9K_CONTEXT_{DEFAULT,SUDO}_{CONTENT,VISUAL_IDENTIFIER}_EXPANSION=
