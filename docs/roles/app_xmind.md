---
title: "Ansible Role: serdigital64.application.app_xmind"
description: "Manage provisioning of the XMind application"
authors:
  - SerDigital64
tags:
  - ansible
...
The **app_xmind** Ansible-Role is part of the [A:Platform64](https://github.com/serdigital64/aplatform64) project and is available in the [application](../collections/application.md) Ansible-Collection.

## Usage

The following example is an **Ansible Playbook** that includes all the supported features:

[use this link if viewing the doc on github](../../collections/serdigital64/application/playbooks/app_xmind.yml)

```yaml
{% include "../../collections/serdigital64/application/playbooks/app_xmind.yml" %}
```
